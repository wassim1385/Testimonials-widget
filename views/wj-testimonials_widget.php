...
<div class="testimonials-item">
    ...
    <div class="content">
        <?php if ( $image ) : ?>
        <?php if ( has_post_thumbnail() )  the_post_thumbnail( array( 70, 70 ) ); endif; ?>
        <?php the_content(); ?>
    </div>
    <div class="meta">
        <?php if ( $occupation ) : ?>
...
?>
<a href="<?php echo get_post_type_archive_link( 'wj-testimonials' ) ?>"><?php esc_html_e( 'Show more testimonials', 'wj-testimonials' ) ?></a>